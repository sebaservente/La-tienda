    ...
    <div class="row row-cols-1 row-cols-md-2 carta-0">
        <div class="col-12">
            <div class="card card-body">
                <h4 class="card-title text-center"> Tienda de Cerveza </h4>
                <p class="card-text text-center">Gran variedad de cerveza, novedosas y de calidad. Conocé nuestros Combos y Comprá Online! ¿Querés conocer nuestra Variedad
                    de Cervezas? Ingresá y encontrá los Packs Destacados. La Revolución de la Birra. En Tienda De Cervezas nos esforzamos para  buscar y seleccionar gran variedad de birras,
    ...
    <div class="row row-cols-1 row-cols-md-2 carta-2">
        <div class="col-12">
            <div class="card card-body">
                ...
                <p class="card-text text-center">Se parte de Tienda de Cervezas y Recibiras incleibles Descuentos.
                     Participar De Nuestros Cursos  sobre Cervezas Artesanales</p>
                     <button class="btn btn-light shadow col-12" onclick="window.location='index.php?s=contacto'">Ingresar</button>
            </div>
        </div>  
    </div>  
